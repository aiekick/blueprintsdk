...
{
    BP_NODE_WITH_NAME(DoorwayFusionNode, "Doorway Transform", VERSION_BLUEPRINT, NodeType::Internal, NodeStyle::Default, "Fusion#Video")
    ...
    bool DrawCustomLayout(ImGuiContext * ctx, float zoom, ImVec2 origin, ImGui::ImCurveEdit::keys * key) override
    {
        ...
        ImGui::SameLine(320);  if (ImGui::Button(ICON_RESET "##reset_reflection##Doorway")) { _reflection = 0.4f; }
        ImGui::SliderFloat("Perspective##Doorway", &_perspective, 0.0, 1.f, "%.1f", flags);
        ImGui::SameLine(320);  if (ImGui::Button(ICON_RESET "##reset_perspective##Doorway")) { _perspective = 0.2f; }
        ImGui::SliderFloat("Depth##Doorway", &_depth, 1.0, 10.f, "%.1f", flags);
        ImGui::SameLine(320);  if (ImGui::Button(ICON_RESET "##reset_depth##Doorway")) { _depth = 3.0f; }
        ImGui::PopItemWidth();

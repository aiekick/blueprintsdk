...
{
    BP_NODE_WITH_NAME(CrossZoomFusionNode, "CrossZoom Transform", VERSION_BLUEPRINT, NodeType::Internal, NodeStyle::Default, "Fusion#Video")
    ...
    bool DrawCustomLayout(ImGuiContext * ctx, float zoom, ImVec2 origin, ImGui::ImCurveEdit::keys * key) override
    {
        ...
        ImGui::SameLine(320);  if (ImGui::Button(ICON_RESET "##reset_strength##CrossZoom")) { _strength = 0.4f; }
        ImGui::PopItemWidth();
